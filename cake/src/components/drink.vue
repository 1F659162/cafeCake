    ...
    <div class="container" v-if="status == '1'" >
            <div class="row">
                <div v-for="product in products" :key="product._id">
                    <div class="col-md-4" align="center" v-if="product.category=='T2'"  style="margin-top:30px;">
                        <div class="card h-100" v-if="product.category=='T2'"  style="width:18rem; margin-left:46px;">
                            <a >
